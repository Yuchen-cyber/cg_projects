...
// shapes.
  ...
  // how many floats total needed to store all shapes?
	var mySiz = (cylVerts.length + sphVerts.length + 
							 torVerts.length + gndVerts.length + diaVerts.length);						
...
var capVerts = 12;	// # of vertices around the topmost 'cap' of the shape
var botRadius = 1.6;		// radius of bottom of cylinder (top always 1.0)


diaVerts = new Float32Array(  ((capVerts*6) -2) * floatsPerVertex);
